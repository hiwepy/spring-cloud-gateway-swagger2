...
> **Current Version**：`Hoxton.x.20240823.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:spring-cloud-gateway-swagger2:Hoxton.x.20240823.RELEASE` |
...
|---|---:|---|
| JDK | `17` | `pom.xml` |
| Spring Boot | `Hoxton.SR12` | `pom.xml` parent |
...
<dependency>
    ...
    <version>Hoxton.x.20240823.RELEASE</version>
</dependency>
```

...
> **Current Version**：`2021.0.x.20240823.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:spring-cloud-gateway-swagger2:2021.0.x.20240823.RELEASE` |
...
|---|---:|---|
| JDK | `17` | `pom.xml` |
| Spring Boot | `2021.0.8` | `pom.xml` parent |
...
<dependency>
    ...
    <version>2021.0.x.20240823.RELEASE</version>
</dependency>
```

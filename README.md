...
> **Current Version**：`2023.0.x.20240823.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:spring-cloud-gateway-swagger2:2023.0.x.20240823.RELEASE` |
...
|---|---:|---|
| JDK | `17` | `pom.xml` |
| Spring Boot | `2023.0.3` | `pom.xml` parent |
...
<dependency>
    ...
    <version>2023.0.x.20240823.RELEASE</version>
</dependency>
```
